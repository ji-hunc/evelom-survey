    ...
    <div className="min-h-screen gradient-bg">
      ...
      <header className="py-4 sm:py-6 px-4 sm:px-6 border-b border-white/20">
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          <h1 className="text-xl sm:text-2xl font-bold gradient-text">EVELOM</h1>
          <nav className="flex space-x-4 sm:space-x-8">
            <Link href="/" className="text-sm sm:text-base text-gray-700 hover:text-[#4a7c59] transition-colors">홈</Link>
            <Link href="/survey" className="text-sm sm:text-base text-gray-700 hover:text-[#4a7c59] transition-colors">설문 시작</Link>
          </nav>
        </div>
      </header>
      ...
      <section className="py-12 sm:py-20 px-4 sm:px-6 bg-white/50">
        <div className="max-w-6xl mx-auto">
          <h3 className="text-2xl sm:text-3xl font-light text-center mb-8 sm:mb-16 text-gray-800">
            EVELOM 클렌저 컬렉션
          </h3>
      ...
      <footer className="py-8 sm:py-12 px-4 sm:px-6 border-t border-white/20">
        <div className="max-w-6xl mx-auto text-center">
          <h1 className="text-2xl sm:text-3xl font-bold gradient-text mb-4">EVELOM</h1>
